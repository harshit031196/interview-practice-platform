...
import { Brain, Users, TrendingUp, Play, Star, CheckCircle } from 'lucide-react'
      ...
      <section className="container mx-auto px-4 py-16 text-center">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-5xl font-bold text-gray-900 mb-6">
            Prepare for Difficult Conversations with{' '}
            <span className="text-primary">Wingman</span>
          </h1>
          <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
            Practice challenging conversations, get feedback from industry experts, 
            and build confidence. Navigate any difficult situation with ease.
          </p>
